  ...
  return (
    <div>
      {!open ? (
        ...
        <form action={async (fd) => { await action(fd); setOpen(false) }} className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 bg-white/[0.08] border border-white/[0.12] rounded-[5px] py-[5px] px-2 text-[12px] text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:border-white/30"
            />
            <button
              type="button"
          ...
          {isCardio ? (
            <input
              ...
              min="0"
              placeholder="min"
              className="w-20 bg-white/[0.08] border border-white/[0.12] rounded-[5px] py-[5px] px-2 text-[12px] text-zinc-100 focus:outline-none focus:border-white/30"
            />
          ) : (
            <div className="flex gap-2">
              <label className="flex flex-col gap-0.5">
                <span className="text-[11px] text-zinc-500">Series</span>
                <input name="sets" type="number" min="1" defaultValue={defaultSets} className="w-16 bg-white/[0.08] border border-white/[0.12] rounded-[5px] py-[5px] px-2 text-[12px] text-zinc-100 focus:outline-none focus:border-white/30" />
              </label>
              <label className="flex flex-col gap-0.5">
                <span className="text-[11px] text-zinc-500">{repsLabel}</span>
                <input name="reps" type="number" min="0" defaultValue={defaultReps || ''} className="w-16 bg-white/[0.08] border border-white/[0.12] rounded-[5px] py-[5px] px-2 text-[12px] text-zinc-100 focus:outline-none focus:border-white/30" />
              </label>
              {defaultRir !== null && (
                <label className="flex flex-col gap-0.5">
                  <span className="text-[11px] text-zinc-500">RIR</span>
                  <input name="rir" type="number" min="0" max="10" defaultValue={defaultRir} className="w-14 bg-white/[0.08] border border-white/[0.12] rounded-[5px] py-[5px] px-2 text-[12px] text-zinc-100 focus:outline-none focus:border-white/30" />
                </label>
              )}
            </div>
          )}
          <button
            type="submit"
            className="rounded-[0.625rem] border border-white/[0.18] px-[10px] py-1 text-[12px] font-medium text-zinc-100 hover:bg-zinc-800 transition-colors self-start"
          >
            Añadir
          </button>
        </form>
